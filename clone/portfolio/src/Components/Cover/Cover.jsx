      ...
      <div className="row align-items-center my-5 py-5">
        <div className="col-lg-7 py-5 order-2 order-lg-1 px-4">
          ...
          <div className="social-media py-3">
            <a
              href="https://in.linkedin.com/in/josnavi-dunga-2417a2258"
              target="_blank"
              className="mx-2"
            >
            ...
            <a
              href="https://github.com/Sindhudunga/"
              target="_blank"
              className="mx-2"
            >
            ...
            <a
              href="https://www.instagram.com/josnavi_10/?hl=en"
              target="_blank"
              className="mx-2"
            >
